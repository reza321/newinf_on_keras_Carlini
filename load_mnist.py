...
def dataset_attacked(dataset_X,dataset_labels):  
  dataset_labels=np.argmax(dataset_labels, axis=1, out=None) # undo one-hot encoding
  attacked_data = DataSet(dataset_X, dataset_labels)
  return base.Datasets(train=attacked_data, validation=None, test=None)
