...
class CarliniL2:
    ...
    def attack_batch(self, imgs, labs):
        ...
        for outer_step in range(self.BINARY_SEARCH_STEPS):
            ...
            #print(np.shape(batch))         # batch    is the data points to be attacked
            #print(batchlab)                # batchlab is the data points labels
            #print(CONST)                   # CONST    is constant which printed to be 0.001
            ...
            for iteration in range(self.MAX_ITERATIONS):
                # perform the attack 
                # test_nimg=self.sess.run(self.newimg)
